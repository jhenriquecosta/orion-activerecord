...
namespace Castle.ActiveRecord.Framework.Scopes
{
	...
	public class DifferentDatabaseScope : AbstractScope
	{
		...
		public DifferentDatabaseScope(DbConnection connection) : this(connection, FlushAction.Auto)
		{
		}
		...
		public DifferentDatabaseScope(DbConnection connection, FlushAction flushAction) : base(flushAction, SessionScopeType.Custom)
		{
