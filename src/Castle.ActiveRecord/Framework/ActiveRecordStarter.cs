...
namespace Castle.ActiveRecord
{
	...
	public static class ActiveRecordStarter
	{
		...
		private static readonly System.Collections.Generic.ISet<Assembly> registeredAssemblies = new HashSet<Assembly>();
		...
		//	ISet assembliesGeneratedXmlFor = new HashSet();  alterado por Henrique 05/02/2018
		...
		{
			ISet<Assembly> assembliesGeneratedXmlFor = new HashSet<Assembly>();
			AssemblyXmlGenerator assemblyXmlGenerator = new AssemblyXmlGenerator();
